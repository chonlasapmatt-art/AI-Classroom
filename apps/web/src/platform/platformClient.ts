...
const messages: Record<string, string> = {
  ...
  REAUTH_PASSWORD_INVALID:
    'รหัสผ่านไม่ถูกต้อง · ช่องนี้ขอรหัสผ่านของบัญชีผู้ดูแลแพลตฟอร์มที่กำลังใช้งานอยู่ ไม่ใช่รหัสผ่านของบัญชีที่กำลังสร้าง',
  PLATFORM_ACCESS_LOCKED:
    'กรอกรหัสผ่านผิดหลายครั้งเกินไป · ระบบล็อกไว้ 15 นาที แล้วจึงลองใหม่ได้',
