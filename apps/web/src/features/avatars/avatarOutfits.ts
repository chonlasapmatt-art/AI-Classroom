...
export const avatarOutfits: AvatarOutfit[] = [
  ...
  { id: 'blazer', name: 'เสื้อสูทนักเรียน', description: 'สำหรับวันพิธีการและการนำเสนอ', shape: 'blazer' },
  { id: 'jersey', name: 'ชุดกีฬา', description: 'พร้อมลงสนามทุกเมื่อ', shape: 'jersey' },
  { id: 'labcoat', name: 'เสื้อกาวน์', description: 'สำหรับห้องทดลอง', shape: 'labcoat', primary: '#f4f6fb', accent: '#94a3b8' },
  { id: 'apron', name: 'ผ้ากันเปื้อนศิลปะ', description: 'เลอะได้เต็มที่ในคาบศิลปะ', shape: 'apron' },
  { id: 'dungarees', name: 'ชุดเอี๊ยม', description: 'สายงานประดิษฐ์และงานช่าง', shape: 'dungarees' }
];
