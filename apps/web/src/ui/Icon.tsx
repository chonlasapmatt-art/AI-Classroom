 ...
 *
 * Every icon is a 24×24 viewBox with stroke-linecap round and stroke-linejoin round,
 * matching the modern, clean aesthetic of the design system. No external icon library
 * is needed — the icons live here and are tree-shaken automatically.
 *
 * Usage: <Icon name="dashboard" />  or  <Icon name="dashboard" size={20} />
 */
import type { SVGProps } from 'react';

type IconName =
  | 'dashboard' | 'announcements' | 'calendar' | 'timetable' | 'bell'
  | 'students' | 'classes' | 'subjects' | 'teachers' | 'parents'
  | 'import' | 'promotion' | 'attendance' | 'assignments' | 'scores'
  | 'gradebook' | 'grade-edit' | 'question-bank' | 'quiz' | 'exams'
  | 'sit-exam' | 'leaderboard' | 'achievements' | 'children' | 'reports'
  | 'operations' | 'settings' | 'profile' | 'avatar-gallery' | 'preview-demo'
  | 'search' | 'close' | 'menu' | 'sync' | 'logout'
...
const icons: Record<IconName, string> = {
  ...
  timetable:
    '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="10" y1="10" x2="10" y2="22"/><line x1="15" y1="10" x2="15" y2="22"/><line x1="3" y1="15" x2="21" y2="15"/>',
  bell:
  ...
  subjects:
    '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/><line x1="10" y1="9" x2="16" y2="9"/><line x1="10" y1="13" x2="14" y2="13"/>',
  teachers:
  ...
  promotion:
    '<polyline points="18 15 12 9 6 15"/><line x1="12" y1="9" x2="12" y2="21"/><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/>',
  attendance:
  ...
  leaderboard:
    '<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><circle cx="18" cy="8" r="2"/><circle cx="12" cy="2" r="2"/><circle cx="6" cy="12" r="2"/>',
  achievements:
  ...
  reports:
    '<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><circle cx="6" cy="14" r="1"/><circle cx="12" cy="4" r="1"/><circle cx="18" cy="10" r="1"/>',
  operations:
