...
function sample(): SchoolSnapshot {
  return {
    ...
    students: [record('student-1', { profileId: 'profile-student-1', studentCode: 'S1', displayName: 'นักเรียนหนึ่ง', avatarIndex: 0, avatarConfig: null, avatarId: null, avatarPhotoId: null, status: 'active' as const }), record('student-2', { profileId: 'profile-student-2', studentCode: 'S2', displayName: 'นักเรียนสอง', avatarIndex: 0, avatarConfig: null, avatarId: null, avatarPhotoId: null, status: 'active' as const }), record('student-3', { profileId: 'profile-student-3', studentCode: 'S3', displayName: 'นักเรียนสาม', avatarIndex: 0, avatarConfig: null, avatarId: null, avatarPhotoId: null, status: 'active' as const })],
    ...
    enrollments: [record('enrollment-1', { studentId: 'student-1', classId: 'class-1', academicTermId: 'term-1', status: 'active' as const, enrolledAt: '', leftAt: null }), record('enrollment-2', { studentId: 'student-2', classId: 'class-2', academicTermId: 'term-2', status: 'active' as const, enrolledAt: '', leftAt: null }), record('enrollment-3', { studentId: 'student-3', classId: 'class-1', academicTermId: 'term-1', status: 'active' as const, enrolledAt: '', leftAt: null })],
...
describe('role room visibility', () => {
  ...
  it('does not reduce the super admin projection', () => {
    ...
    expect(view.students).toHaveLength(3);
  });
