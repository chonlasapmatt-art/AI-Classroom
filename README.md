...
หน้าแรกถามก่อนว่า **คุณคือใคร?** แล้วถามเท่าที่จำเป็นกับบทบาทนั้น ไม่มีอีเมล ไม่มี OTP รายวัน ไม่มีรหัสคำเชิญในเส้นทางปกติ

| บทบาท | เข้าสู่ระบบด้วย | สมัครด้วย |
| --- | --- | --- |
| ครู | ชื่อ + รหัสผ่าน | ชื่อจริง นามสกุล โรงเรียน รหัสผ่าน — ใช้งานได้ทันที |
| ผู้ปกครอง | ชื่อ + รหัสผ่าน | ชื่อจริง นามสกุล รหัสผ่าน — ผูกลูกภายหลัง |
...
- **กู้รหัสผ่านโดยไม่ใช้อีเมล** — ผู้ใช้ส่งคำขอที่ `/forgot-password` แล้วครูหรือผู้ดูแลตั้งรหัสผ่านใหม่ให้ ระบบไม่แสดงรหัสผ่านเดิมและไม่บอกว่าชื่อนั้นมีบัญชีอยู่จริงหรือไม่
