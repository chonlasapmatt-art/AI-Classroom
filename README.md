...
- **เข้าใช้งานสำหรับนักเรียนโดยไม่ต้องมีอีเมลและรหัสผ่าน** — นักเรียนกรอกชื่อกับเลขประจำตัวนักเรียนที่ `/student` ระบบยืนยันตัวตนฝั่งเซิร์ฟเวอร์ผ่าน Edge Function `student-access` แล้วออก session จริงของ Supabase ให้ (RLS ไม่ถูกลดทอน); ครูสร้างระเบียนนักเรียนไว้ก่อนได้ นักเรียนเข้าใช้งานได้ทันทีโดยไม่ต้องสมัคร และการสมัครครั้งแรกที่ `/student/first-time` จะเชื่อมกับระเบียนเดิมแทนการสร้างซ้ำ
- **บัญชีจริงและการกู้รหัสผ่าน** — ครูและผู้ปกครองสมัครผ่าน Supabase Auth พร้อม session restore และ password reset; ตัวเลือกตอนสมัครไม่ให้สิทธิ์โรงเรียนโดยอัตโนมัติ
- **คำเชิญสมาชิกแบบไม่สร้างข้อมูลซ้ำ** — บัญชีใหม่เชื่อมกับ Teacher/Student/Parent record เดิมด้วยรหัส HMAC แบบหมดอายุ/ใช้ครั้งเดียว; ครูที่กรอกรหัสโรงเรียนถูกต้องได้สิทธิ์ `verified_teacher` ทันที ไม่ต้องรออนุมัติ (ผู้ดูแลเพิกถอนภายหลังได้)
