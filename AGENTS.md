...
That is enough to build screens, change behaviour, run all 136 test files and see the result. Most work on
...
There are 94; the last is `202609120002`. Replacing a function in a *new* migration is the repair
...
supabase/
  migrations/     94 immutable migrations
