...
เมนูเขียนแยกตามบทบาท ไม่ใช่รายการเดียวกรองสี่ครั้ง แต่ละบทบาทเห็นหัวข้อหลักไม่เกิน 7–8 หัวข้อ
และตั้งชื่อตามสิ่งที่คนนั้นเปิดแอปมาทำ

| บทบาท | หัวข้อหลักในเมนู |
| --- | --- |
| `admin` | ภาพรวม · นักเรียนและบุคลากร · ห้องเรียนและรายวิชา · งาน คะแนน และการเข้าเรียน · รายงาน · Sync และ Backup · ตั้งค่า |
| `teacher` | วันนี้ · เช็กชื่อ · กิจกรรม · งานและคะแนน · นักเรียน · รายงาน · Sync · โปรไฟล์ |
| `student` | วันนี้ · งานของฉัน · กิจกรรม · คะแนน · ตารางเรียน · เพื่อนร่วมชั้น · โปรไฟล์ |
| `parent` | ลูกของฉัน · การเข้าเรียน · งานและคะแนน · ตารางเรียน · ประกาศ · โปรไฟล์ |

ช่อง **ค้นหาเมนู** อยู่บนสุดของเมนู พิมพ์ชื่อหน้าจอแล้วกดได้เลยโดยไม่ต้องเปิดหัวข้อทีละอัน
บนมือถือมีแถบล่าง 5 ปุ่มของบทบาทนั้น และแถบบนบอกเสมอว่ากำลังอยู่ที่ไหน (โรงเรียน › หัวข้อ › หน้า)
...
| กิจกรรมหน้าชั้น (สุ่มชื่อ · สุ่มทีม · สุ่มคำถาม · จับเวลา) | `/classroom` |
...
ครูเปิด `/operations` ได้แบบอ่านอย่างเดียว: จำนวนที่รอซิงก์ สถานะล่าสุด และปุ่ม Sync Now
การสร้างและกู้คืนไฟล์สำรองยังเป็นสิทธิ์ของแอดมิน เพราะการกู้คืนเขียนทับฐานข้อมูลในเครื่องทั้งโรงเรียน
...
`/reports` เป็น **รายงานของตัวเอง** 4 ชุด: การเข้าเรียน · งานที่ได้รับมอบหมาย · คะแนนที่ได้รับ · เหรียญรางวัล
ส่งออก CSV ได้ และข้อมูลมาจาก snapshot ที่ repository ตัดขอบเขตให้แล้ว จึงกว้างเกินตัวเองไม่ได้
...
`/reports` เป็นรายงานของลูกแบบอ่านอย่างเดียว เลือกลูกได้เมื่อมีหลายคน และส่งออก CSV ได้
...
### ครู: เปิดกิจกรรมหน้าชั้น

`/classroom` → เลือกห้องและวิชา → สุ่มชื่อ สุ่มทีม สุ่มคำถาม หรือจับเวลา → แตะให้ XP หรือมอบเหรียญ
แต้มจากหน้านี้เป็นคะแนนการมีส่วนร่วม (`participation`) ไม่ใช่คะแนนเก็บของวิชา และบันทึกผู้ให้ เหตุผล เวลาไว้ทุกครั้ง
รายละเอียด: `docs/32_CLASSROOM_LIVE_TOOLS.md`
...
| กิจกรรมหน้าชั้นและการให้แต้ม | `docs/32_CLASSROOM_LIVE_TOOLS.md` |
